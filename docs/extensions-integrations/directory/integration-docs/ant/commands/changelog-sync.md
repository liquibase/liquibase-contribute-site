...
<h1>Ant <code>changeLogSync</code></h1>
<p>Marks all changesets as ran against the database. Useful when you have manually updated your database.</p>
<h2 id="syntax">Syntax</h2>
<pre xml:space="preserve"><code class="language-xml" data-lang="xml">&lt;liquibase:changeLogSync  
    ...
    &lt;liquibase:database  
        ...
        user="${db.user}"  
        password="${db.pasword}"/&gt;  
&lt;/liquibase:changeLogSync&gt;</code></pre>
<p>A basic implementation of the changelog sync task. Syncs the changelog file to the database.</p>
...
<p>Syncs the referenced database with the changesets found in the given changelog file.</p>
