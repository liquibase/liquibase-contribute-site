...
title: tagDatabase
---
<h1>Ant <code>tagDatabase</code></h1>
<p>Tags the database for possible future rollback.</p>
<h2 id="syntax">Syntax</h2><pre xml:space="preserve"><code class="language-xml" data-lang="xml">&lt;liquibase:tagDatabase
    tag="my-tag"&gt;
    &lt;liquibase:database
        driver="${db.driver}"
        url="${db.url}"
...
&lt;/liquibase:tagDatabase&gt;</code></pre>
<h2 id="available-parameters">Parameters</h2>
<table>
    <thead>
        <tr>
