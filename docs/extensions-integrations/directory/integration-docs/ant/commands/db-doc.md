...
<h1>Ant <code>dbDoc</code></h1>
<p>Generates <a href="https://docs.liquibase.com/commands/change-tracking/db-doc.html">db-doc</a> database documentation for a given database.</p>
<h2 id="syntax">Syntax</h2>
<pre xml:space="preserve">
<code class="language-xml" data-lang="xml">&lt;liquibase:dbDoc  
    ...
    outputDirectory="/path/to/output/dir"&gt;  
        &lt;liquibase:database  
            ...
            user="${db.user}"  
            password="${db.pasword}"/&gt;  
&lt;/liquibase:dbDoc&gt;</code></pre>
<p>A basic example of generating database documentation for a given changelog file.</p>

<pre xml:space="preserve"><code class="language-xml" data-lang="xml">&lt;liquibase:dbDoc  
    databaseRef="my-database"  
    changeLogFile="/path/to/changelog.xml"  
    outputDirectory="/path/to/output/dir"/&gt;</code></pre>
<p>Generates database documentation for the referenced database.</p>
