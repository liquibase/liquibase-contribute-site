...
<p>To use Liquibase and Firebird, you need  the <a href="https://firebirdsql.org/en/jdbc-driver/">JDBC driver JAR file</a> (<a href="https://mvnrepository.com/artifact/org.firebirdsql.jdbc/jaybird">Maven download</a>).</p>
<p>
...
<a style="font-size: 18pt;" href="#">JSON example</a>
