...
<p>To use Liquibase and MaxDB, you need:</p>
<ul>
    <li>The <a href="https://maxdb.sap.com/maxdb.md">JDBC driver JAR file</a></li>
    <li>The latest <a href="https://github.com/liquibase/liquibase-maxdb/releases">Liquibase MaxDB extension JAR file</a></li>
</ul>
