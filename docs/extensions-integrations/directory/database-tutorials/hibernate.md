...
<a href="#"><code>Item.java</code></a>
	...
	<li value="8">Next, generate a <code>dbchangelog.xml</code> file from Hibernate in your project folder:</li><pre xml:space="preserve"><code class="language-text"><span class="mc-variable General.liquiPropFile variable">liquibase</span> mvn liquibase:diff</code></pre>
