...
| liquibase.database       | Database                   | Database Support | [Defines a database dialect](../Extensions & Integrations/Extension Guides/additional-databases/index.md)                                                                               |
|                          | DatabaseConnection         | Database Support | Wraps the underlying connection [to a database](../Extensions & Integrations/Extension Guides/additional-databases/index.md)                                                            |
| liquibase.datatype       | DataTypeFactory            | Database Support | Translates generic to [database specific](../Extensions & Integrations/Extension Guides/additional-databases/index.md) data types and vice versa                                        |
...
| liquibase.executor       | ExecutorService            | Infrastructure   | Facade for [executing statements](../Extensions & Integrations/Extension Guides/runwith-executors/index.md)                                                                             |
|                          | Executor                   | Database Support | [Defines a new RunWith Executor](../Extensions & Integrations/Extension Guides/runwith-executors/index.md)                                                                              |
...
| liquibase.parser         | ChangeLogParser            | Changelog Files  | [Defines changelog file formats](../Extensions & Integrations/Extension Guides/changelog-formats/index.md)                                                                              |
...
| liquibase.precondition   | Precondition               | Preconditions    | [Defines preconditions](../Extensions & Integrations/Extension Guides/preconditions/index.md)                                                                                           |
...
| liquibase.serializer     | ChangeLogSerializer        | Changelog Files  | Allows [changelog file formats](../Extensions & Integrations/Extension Guides/changelog-formats/index.md) to be used in diffChangelog and generateChangelog operations                  |
